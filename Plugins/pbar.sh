...
echo "---"
echo "UUID"
echo "-- Show | bash='$HOME/p3/pansift_uuid_show.sh' terminal=false"
echo "-- Get UUID from Web | bash='$HOME/p3/pansift_webapp.sh' terminal=false"
echo "-- Reset/Update | bash='$HOME/p3/pansift_uuid_update.sh' terminal=false"
echo "Token"
echo "-- Show | bash='$HOME/p3/pansift_token_show.sh' terminal=false"
echo "-- Get Token from Web | bash='$HOME/p3/pansift_webapp.sh'"
echo "-- Reset/Update | bash='$HOME/p3/pansift_token_update.sh' terminal=false"
echo "---"
