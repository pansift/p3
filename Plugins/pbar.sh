...
echo "Token"
echo "-- Show Token | bash='$HOME/p3/pansift_uuid_show.sh' terminal=false"
echo "-- Get Token from Web | bash='$HOME/p3t/pansift_webapp.sh' terminal=false"
echo "-- Reset/Update Token | bash='$HOME/p3t/pansift_uuid_update.sh' terminal=false"
echo "---"
echo "Update"
