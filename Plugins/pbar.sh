...
echo "-- New Token | bash='$HOME/p3t/pansift_webapp.sh' terminal=false"
echo "-- Reset/Update UUID | bash='$HOME/p3t/pansift_token_update.sh' terminal=false"
echo "---"
...
echo "---"
echo "Log In / Web App | bash='open https://pansift.com' terminal=false"
