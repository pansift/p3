...
# We are intentionally not updating the main pansift script and the Plugins/pbar to leave them for manual app installs.
# Also we don't want to update ourselves in case we break.
