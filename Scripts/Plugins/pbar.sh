...
echo "-- Get UUID from Web | bash='$PANSIFT_SCRIPTS/pansift_webapp.sh -s' terminal=false"
echo "Token"
...
echo "-- Get Token from Web | bash='$PANSIFT_SCRIPTS/pansift_webapp.sh -s' terminal=false"
echo "---"
